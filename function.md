...
在[上期文章](https://github.com/dafei1288/CalciteDocTrans/blob/master/helloworld.md)撰写的时候，我还认为只完成了单表查询，但经过几天的研究发现，上次那寥寥几十行代码，其实已经可以完成了表联接，过滤等功能了，只是由于当时粗心写错了一些东西，造成过滤失效了，下面我来剖析一下问题。

首先在`Storage.java`这个文件里
```
